    ...
    def start_managed(
        ...
        **kwargs: Any,
            ...
            try:
                ...
                with self._lock:
                    ...
                    if resource is not None:
                        ...
                        use.users -= 1
                        if use.users == 0 and use.closer is not None and not use.closed:
                            use.closed = True
                            closers.append(use.closer)
        ...
        with self._lock:
            ...
            if resource is not None:
                use = self._resources.setdefault(resource, _ResourceUse())
                if use.closed or use.closer is not None:
                    logger.debug(
